  ...
  return (
    <div className='m-10'>
      <div className='m-10'>
        <button
          type='button'
          className='rounded-full bg-teal-800 px-20 py-3 font-sans text-base text-white shadow-sm hover:bg-teal-700'
        >
          Primary button
        </button>
      </div>
      <div className='m-10'>
        <button
          type='button'
          className='rounded-full bg-teal-400 px-20 py-3 font-sans text-base text-white shadow-sm hover:bg-teal-300'
        >
          Secondary button
        </button>
      </div>
      <div>
        <div className='m-10'>
          <label htmlFor='email' className='block text-sm font-medium leading-6 text-teal-500'>
            Email
          </label>
          <div className='mt-0'>
            <input
      ...
      <div className='m-10'>
        ...
        <p className='mt-0 text-sm text-red-500 underline' id='email-error'>
      ...
      <div className='m-10'>
        <label
          htmlFor='email'
          className='flex justify-between text-sm font-medium leading-6 text-teal-500'
        >
          <p>Password</p>
          <div className='flex items-center'>
            <EyeSlashIcon className='mx-1 h-4 w-4 text-gray-500' />
